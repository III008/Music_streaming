		...
		<section class="section_1">
			<div>
				...
				<table class="notice_content">
					<tr>
						<td colspan="7"><a href="notice_list.jsp?nid=<%=nid%>"><button
									type="button" class="btn_style">목록으로</button></a> <a
							href="notice_update.jsp?nid=<%=vo.getNid()%>"><button
									type="button" class="btn_style">수정하기</button></a> <a
							href="notice_delete.jsp?nid=<%=vo.getNid()%>"><button
					...
					<tr>
						<td colspan="7">
							<p>
								...
								<img
									src="http://localhost:9000/Music_streaming/upload/<%=vo.getNsfile()%>"
									width="50%">
								<% } %>
							</p>
						</td>
