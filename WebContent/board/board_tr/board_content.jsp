		...
		<div class="content_board">
				...
				<div>
					...
					<table class="board_content">
						<tr>
							...
							<td colspan="3">
								<a href="board_update.jsp?tr_bid=<%=tr_bid%>"><button type="button" class="btn_style">수정</button></a>
								<a href="board_delete.jsp?tr_bid=<%=tr_bid%>"><button type="button" class="btn_style_2">삭제</button></a>
							</td>
						</tr>
						<tr>
			...
			<section class="section_2">
				...
				<form name="boardReplyForm" action="boardReplyProc.jsp" method="post" class="reply_write">
					...
					<input type="hidden" name="tr_bid" value="<%= vo.getTr_bid() %>">
